...
importGeometry(modelAccel,'TOFDetector.stl');

% figure(3);
% pdegplot(modelAccel,'FaceLabels','on','FaceAlpha',1);
% xlabel('x');
% ylabel('y');
% zlabel('z');
...
importGeometry(modelEinzel,'TOFDetector.stl');
...
modelDet = createpde();
importGeometry(modelDet,'TOFDetector.stl');
