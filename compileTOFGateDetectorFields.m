...
modelDet = createpde();
importGeometry(modelDet,'TOFGateDetectorOffset365pt5.stl');
...
importGeometry(modelGateTop,'TOFGateDetectorOffset365pt5.stl');
...
importGeometry(modelGateBottom,'TOFGateDetectorOffset365pt5.stl');
